    ...
    <div class="container-login100">
        <div class="wrap-login100 p-6">
            <div class="d-flex justify-content-center align-items-center">
                @if(!$web || $web->web_logo == '' || $web->web_logo == 'default.png')
                    <img class="rounded-3" src="{{ url('/assets/default/web/default.png') }}" height="100px" alt="logo">
                @else
                            ...
                            <div class="tab-pane active" id="tab5">
                                <div class="wrap-input100 validate-input input-group"
                                    ...
                                    <input name="user" value="{{Session::get('userInput')}}"
                                        class="input100 border-start-0 form-control ms-0" type="text" placeholder="Username"
                                        autocomplete="off">
                                </div>
