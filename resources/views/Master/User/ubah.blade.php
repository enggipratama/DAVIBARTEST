                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamatU" class="form-control" placeholder="Alamat..">
                            </div>
                            <div class="form-group">
...
<script>
    function validateFormUpdate() {
        ...
        const notlp = document.forms["myFormU"]["notlpU"].value;
        const alamat = document.forms["myFormU"]["alamatU"].value;
        ...
        if (namaL == "") {
            ...
            $("input[name='notlpU']").addClass('is-invalid');
            return false;
        } else if (user == '') {
    ...
    function resetValidU() {
        ...
        $("input[name='notlpU']").removeClass('is-invalid');
