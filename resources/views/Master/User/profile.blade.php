            ...
            <form action="{{url('/admin/updateProfile').'/'.$data->user_id}}" method="POST" name="myFormUpdate" enctype="multipart/form-data" onsubmit="return validateUpdate()">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="notlp" value="{{$data->user_notlp}}" class="form-control" id="notlp" placeholder="No Telpon">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <input type="text" name="alamat" value="{{$data->user_alamat}}" class="form-control" id="alamat" placeholder="Alamat">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function validateUpdate() {
        ...
        const notlp = document.forms["myFormUpdate"]["notlp"].value;
        const alamat = document.forms["myFormUpdate"]["alamat"].value;
        ...
        if (nmlengkap == "") {
            ...
            $("input[name='notlp']").addClass('is-invalid');
            return false;
        } else if (alamat == "") {
    ...
    function resetValid() {
        ...
        $("input[name='notlp']").removeClass('is-invalid');
