...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 14, 2025 at 09:09 AM
...
CREATE TABLE `tbl_pesan` (
  `pesan_id` bigint(20) UNSIGNED NOT NULL,
  `pesan_idbarang` int(11) NOT NULL,
  `pesan_idtransaksi` int(11) NOT NULL,
  `pesan_jumlah` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_status_order` (
  ...
  `status` enum('Pending','Dikirim','Selesai','Dibatalkan') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `bukti_bayar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metode_bayar` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `diskon` int(11) NOT NULL,
  `status_tanggal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_user` (
  ...
  `user_notlp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_alamat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tbl_web` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `web_bca` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_bri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_mandiri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_ewallet` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_bca_an` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_bri_an` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_mandiri_an` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_ewallet_an` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_alamat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `web_tlpn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `tbl_akses`
  MODIFY `akses_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2077;
...
--
ALTER TABLE `tbl_barang`
  MODIFY `barang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tbl_jenisbarang`
  MODIFY `jenisbarang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_menu`
--
ALTER TABLE `tbl_menu`
  MODIFY `menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1709484340;
...
--
ALTER TABLE `tbl_pesan`
  MODIFY `pesan_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `tbl_submenu`
  MODIFY `submenu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
