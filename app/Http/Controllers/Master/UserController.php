            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $array = array(
                        ...
                        "user_alamat" => trim(preg_replace('/[^A-Za-z0-9-]+/', '_', $row->user_alamat)),
                        "user_foto" => $row->user_foto,
                        "role_id" => $row->role_id,
                        "user_notlp" => $row->user_notlp,
        ...
        if ($request->hasFile('photoU')) {
            ...
            if ($request->pwd == '') {
                ...
                $user->update([
                    ...
                    'user_notlp'   => $request->notlpU,
                    'user_alamat'   => $request->alamatU,
